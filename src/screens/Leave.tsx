    ...
    <View style={styles.leavecontainer}>
      ...
      {showEPicker && (
        ...
        isVisible ={true}
          ...
          onConfirm={(date) => {
            setShowEPicker(false);
            date && setValue('eDate', date, true);
          }}
          onCancel={()=> setShowEPicker(false)}
      ...
      {status === 'pending' ? (
        ...
        <>
          ...
          {errors.eDate && (
            <Text style={{ backgroundColor: appColors.red, fontSize:10, color:'white',padding:5, textAlign: 'center', margin:5 }}>
              Invalid! Please check your leave availibilty.
            </Text>
          )}
          <View
            style={{
